...
open GeneSort.Component.Mp.Sorter
open GeneSort.Component.Mp.Sortable
            ...
            try
                ...
                let! domainData =
                    ...
                    | outputDataType.SorterModelSet _ ->
                        async {
                            let! domain = deserializeDto<sorterModelSetDto, sorterModelSet> stream token SorterModelSetDto.toDomain
                    ...
                    | outputDataType.SorterSetEval _ ->
                        async {
                            let! domain = deserializeDto<sorterModelSetEvalDto, sorterModelSetEval> stream token SorterSetEvalDto.toDomain
