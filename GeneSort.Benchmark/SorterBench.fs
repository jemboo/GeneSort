...
type MergeEvalBench() =
    ...
    member this.Setup() =
        ...
        let sorterModelSet = sorterModelSetMaker.MakeSortingSet (UMX.tag<sortingSetId> (Guid.NewGuid()))
...
type FullBoolEvalBench() =
    ...
    member this.Setup() =
        ...
        let sortingSet = sortingGenSegment.MakeSortingSet (UMX.tag<sortingSetId> (Guid.NewGuid()))
