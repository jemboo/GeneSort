...
//|-------------- |--------------- |------------- |------------ |--------- |---------- |--------------- |----------:|----------:|----------:|----------:|----------:|----------:|----------:|
//| evalUint8v256 | 6              | 48           | 100         | 1000     | 1         | False          |  24.68 ms |  0.573 ms |  0.341 ms |  312.5000 |  250.0000 |         - |  16.85 MB |
//| evalUint8v256 | 6              | 48           | 100         | 1000     | 1         | True           |  60.71 ms |  4.485 ms |  2.967 ms | 1666.6667 | 1333.3333 |  333.3333 |  71.08 MB |
//| evalUint8v256 | 6              | 48           | 100         | 10000    | 1         | False          | 245.92 ms | 39.655 ms | 26.230 ms | 4333.3333 | 4000.0000 | 1000.0000 |  160.6 MB |
//| evalUint8v256 | 6              | 48           | 100         | 10000    | 1         | True           | 243.12 ms |  8.316 ms |  5.501 ms | 6000.0000 | 5500.0000 | 1000.0000 | 245.41 MB |
//| evalUint8v256 | 6              | 48           | 100         | 30000    | 1         | False          | 636.51 ms |  7.985 ms |  4.752 ms | 2000.0000 | 2000.0000 | 2000.0000 | 538.43 MB |
//| evalUint8v256 | 6              | 48           | 100         | 30000    | 1         | True           | 690.87 ms | 15.982 ms | 10.571 ms | 2000.0000 | 2000.0000 | 2000.0000 | 590.62 MB |


//| Method        | mergeDimension | sortingWidth | sorterCount | ceLength | chunkSize | collectResults | Mean      | Error     | StdDev    | Gen0      | Gen1      | Gen2      | Allocated |
//|-------------- |--------------- |------------- |------------ |--------- |---------- |--------------- |----------:|----------:|----------:|----------:|----------:|----------:|----------:|
//| evalUint8v256 | 4              | 32           | 100         | 1000     | 1         | False          |  1.981 ms | 0.0255 ms | 0.0133 ms |  199.2188 |  179.6875 |         - |    9.5 MB |
//| evalUint8v256 | 4              | 32           | 100         | 1000     | 1         | True           |  2.058 ms | 0.0448 ms | 0.0296 ms |  214.8438 |  191.4063 |         - |  10.23 MB |
//| evalUint8v256 | 4              | 32           | 100         | 10000    | 1         | False          | 14.753 ms | 0.2198 ms | 0.1454 ms | 2109.3750 | 1250.0000 |  125.0000 |  95.52 MB |
//| evalUint8v256 | 4              | 32           | 100         | 10000    | 1         | True           | 18.473 ms | 0.2685 ms | 0.1776 ms | 1968.7500 |  968.7500 |         - |  95.77 MB |
//| evalUint8v256 | 4              | 32           | 100         | 30000    | 1         | False          | 48.819 ms | 1.4172 ms | 0.9374 ms | 1090.9091 | 1090.9091 | 1090.9091 | 286.27 MB |
//| evalUint8v256 | 4              | 32           | 100         | 30000    | 1         | True           | 50.286 ms | 1.2656 ms | 0.8371 ms | 1636.3636 | 1636.3636 | 1636.3636 | 286.52 MB |
