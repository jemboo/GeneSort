...
module FullBoolEvals =
    ...
    let projectFolder = "c:\\Projects\\FullBoolEvals" |> UMX.tag<pathToProjectFolder>
    let projectDesc = "FullBoolEvals on RandomSorters with SortingWidth from 4 to 24 generated by Msce, Mssi, Msrs, and Msuf"
    ...
    let executor
        ...
        asyncResult {
            try
                ...
                let! sortingSet = loadRes |> OutputData.asSortingSet |> asAsync
                ...
                let passingSortingSet = SorterSetEval.makePassingSortingSet 
                                            (%qpEval.Id |> UMX.tag<sortingSetId>) 
                                            sortingSet 
                                            sorterSetEval
