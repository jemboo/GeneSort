...
module MergeIntTests = 

    let projectDir = "c:\Projects"
    
    let experimentName = "MergeIntTest"
    let experimentDesc = "MergeIntTest RandomSorters with SortingWidth from 4 to 16 generated by Msce, Mssi, Msrs, and Msuf"
