...
module MergeIntQa =
    ...
    let sortableArrayDataTypeKeyValues = [ sortableArrayDataType.Ints; sortableArrayDataType.Bools ] |> List.map(SortableArrayDataType.toString)
  
    //let sortableArrayDataTypeValues
