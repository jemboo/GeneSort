...
module MergeIntQa =
    ...
    let projectFolder = "c:\\Projects\\MergeIntQa"  |> UMX.tag<pathToProjectFolder>
    ...
    let executor
        ...
        asyncResult {
            try
                ...
                let! rawTestData = dbSortableMergeTests.loadAsync qpTests 
                ...
                // 6. Save
                let! _ = db.saveAsync 
                                queryParamsForSorterSetEval 
                                (sorterSetEval |> outputData.SorterSetEval) 
                                allowOverwrite
