...
module RandomSorterBins =
    ...
    let enhancer (rp : runParameters) : runParameters =
        ...
        let sorterCount = 3 |> UMX.tag<sorterCount>
    ...
    let executor
        ...
        asyncResult {
            try
                ...
                let sortingResultSetMap = SortingResultSetMap.fromSortingSet sortingSet
                sortingResultSetMap.UpdateManySortingResults sorterSetEval.SorterEvals


                // 7. Make the bins and the filter
                let sorterEvalBins = SorterEvalBins.createFromSorterSetEval sorterSetEval
