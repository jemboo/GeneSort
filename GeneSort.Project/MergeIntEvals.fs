...
module MergeIntEvals =
    ...
    let projectName = "MergeIntEvals3"  |> UMX.tag<projectName>
    let projectDesc = "MergeIntEvals3 on RandomSorters with SortingWidth from 4 to 16 generated by Msce, Mssi, Msrs, and Msuf"
