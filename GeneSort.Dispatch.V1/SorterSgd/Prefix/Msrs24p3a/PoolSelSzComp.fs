...
module PoolSelSzComp =
    ...
    let dbNamePools4096 = "PoolsSelSzTest_4096" |> UMX.tag<databaseName>
    ...
    let dbFolderPools4096 = @$"c:\Projects\{%projName}\{%dbNamePools4096}\Data" |> UMX.tag<pathToRootFolder>
    ...
    let databaseConfigs : Map<string<databaseName>, IGeneSortDb> = 
        [ 
            ...
            (dbNamePools4096, dbPools4096 :> IGeneSortDb);
