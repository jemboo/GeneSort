...
module Uf6MutationRatesDto =
    ...
    let toUf6MutationRatesDto (uf6MutationRates: Uf6MutationRates) : Uf6MutationRatesDto =
        { Order = uf6MutationRates.order
          Seed6TransitionRates = Seed6TransitionRatesDto.fromSeed6TransitionRates uf6MutationRates.seed6TransitionRates
          OpsTransitionRates = OpsTransitionRatesArrayDto.fromOpsTransitionRatesArray uf6MutationRates.opsTransitionRates }

    let fromUf6MutationRatesDto (dto: Uf6MutationRatesDto) : Uf6MutationRates =
        try
            ...
            { order = dto.Order
              seed6TransitionRates = Seed6TransitionRatesDto.toSeed6TransitionRates dto.Seed6TransitionRates
              opsTransitionRates = OpsTransitionRatesArrayDto.toOpsTransitionRatesArray dto.OpsTransitionRates }
        with
