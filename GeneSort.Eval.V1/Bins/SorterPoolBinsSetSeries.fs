...
type sorterPoolBinsSetSeries =
    ...
    static member create (id: Guid<sorterPoolBinsSetSeriesId>) (sets: seq<sorterPoolBinsSet>) =
        let setsMap =
            sets
...
module SorterPoolEvalBinsSetCollection =
    ...
    let add (binSet: sorterPoolBinsSet) (collection: sorterPoolBinsSetSeries) : sorterPoolBinsSetSeries =
        ...
        sorterPoolBinsSetSeries.recreate collection.SorterPoolEvalBinsSetCollectionId updatedMap
