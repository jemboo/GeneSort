...
module SimdGoldenHashProvider =
    ...
    let private calculateGolden (width: int<sortingWidth>) : uint32[] =
        ...
        let tempBlock = simdSortBlock.createFromVectors vectors 32
        
        // ComputeLaneHashes32 is the method using UnpackLow/High + MultiplyLow
        SimdSortBlock.computeLaneHashes32 tempBlock.Vectors
