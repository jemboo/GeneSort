...
module RandomSorterBins =
    ...
    let projectFolder = "c:\\ProjectsV1\\RandomSorterBins\\Data" |> UMX.tag<pathToProjectFolder>
    ...
    let executor (host: randomSorterBinsHost) (runParameters: runParameters) 
        ...
        asyncResult {
            try
                ...
                // 7. Generate DataTable Report

                let dtRecords = SorterEvalBins.makeDataTableRecords sorterEvalBins |> Seq.toArray
                let strSq = dataTableRecord.createTable dtRecords
