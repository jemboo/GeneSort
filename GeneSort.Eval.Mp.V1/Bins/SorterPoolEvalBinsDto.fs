...
module SorterPoolEvalBinsDto =
    ...
    let fromDomain (poolBins: sorterPoolBins) : sorterPoolEvalBinsDto = {
    ...
    let toDomain (dto: sorterPoolEvalBinsDto) : sorterPoolBins =
        ...
        sorterPoolBins.recreate id poolId bins