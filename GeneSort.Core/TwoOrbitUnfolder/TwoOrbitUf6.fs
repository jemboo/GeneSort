...
type TwoOrbitUf6 = private { seed6TwoOrbitType: Seed6TwoOrbitType; twoOrbitUnfolderSteps: TwoOrbitUfStep list; } with
    ...
    member this.Seed6TwoOrbitType with get() : Seed6TwoOrbitType  =
    ...
    member this.MakePerm_Si : Perm_Si =
        ...
        let seedTwoOrbitPairs = 
                this.seed6TwoOrbitType 
                    |> Seed6TwoOrbitType.getTwoOrbits
