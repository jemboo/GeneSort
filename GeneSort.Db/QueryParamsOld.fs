...
type queryParamsOld =
    ...
    static member create(
            ...
            repl: int<replNumber> option, 
            generation: int<generationNumber> option, 
            outputDataType: outputDataType) : queryParamsOld =
        {
    ...
    static member createForProject(projectName: string<projectName>) : queryParamsOld =
        {
    ...
    static member createForTextReport
            ...
            (textReportName: string<textReportName>) : queryParamsOld =
        {
            projectName = (Some projectName)
            index = None
            repl = None
    ...
    static member createFromRunParams 
                (outputDataType:outputDataType)
                (runParams: runParameters) : queryParamsOld =
        {
